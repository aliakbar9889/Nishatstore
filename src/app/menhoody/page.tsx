...
import { MenHoodiesQuery } from '@/sanity/lib/query';
...
const ShopPage = () => {
  ...
  const hardcodedLinks = [
    '/product35', '/product19', '/product11', '/product21', '/product36',
  ];
  ...
  const fetchData = useCallback(async () => {
    try {
      let query = MenHoodiesQuery;
      const params: QueryParams = {};

      if (searchTerm) {
        query = `*[_type == "product" && category == "men" && subcategory == "hoodies" && lower(title) match lower($searchTerm)]`;
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="flex justify-start w-32 sm:w-40 relative">
            <input
              ...
              placeholder="Search mens hoodies..."
          ...
          <div className="text-center flex-1">
            ...
            <p className="text-gray-500 mt-2 text-sm md:text-base">Discover the latest mens hoodies at unbeatable prices.</p>
          </div>
